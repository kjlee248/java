...
public class Triangle
{
	...
	public Triangle(Triangleservice service) {
	...
	public int getArea()
	{
			return ((service.getTotalLength(side1,side2,side3)
			/ 2)
			* (service.getTotalLength(side1,side2,side3) / 2 - side1)
			* (service.getTotalLength(side1,side2,side3) / 2 - side2)
			* (service.getTotalLength(side1,side2,side3) / 2 - side3));
	}
